...
class MLPPolicy(BasePolicy):
    ...
    def get_action(self, obs):
        ...
        return self.sess.run(self.sample_ac, feed_dict= {self.observations_pl:observation}) # Added by Utsav
...
class MLPPolicySL(MLPPolicy):
    ...
    def define_train_op(self):
        ...
        self.loss = tf.losses.mean_squared_error(true_actions, predicted_actions) # Added by Utsav
