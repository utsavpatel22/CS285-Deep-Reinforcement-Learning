...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        random_indices = np.random.permutation[self.obs.shape[0]] # Added by Utsav
        random_indices = random_indices[:batch_size] # Added by Utsav
        return self.obs[random_indices], self.acs[random_indices], self.rews[random_indices], self.next_obs[random_indices], self.terminals[random_indices] # Added by Utsav
